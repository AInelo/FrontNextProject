        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md sm:text-center">
                    <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl dark:text-white">Abonnez vous a notre newsletter</h2>
                    <p className="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">
                        Restez informer des dernieres modification,
                        des derniers articles sur notre site.
                        l'abonnement est gratuit. Vous avez
                        juste qu'a mettre votre email ici
                    </p>
                    <form action="#">
